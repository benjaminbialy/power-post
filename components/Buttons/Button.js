  ...
  return (
    <button
      ...
      className={
        ...
        style +
        (accent
          ? "  focus:ring-blue-400 hover:bg-blue-600 bg-blue-400 text-white"
          : "  focus:ring-neutral-200 hover:bg-neutral-100 border-neutral-200 border-2 border-solid text-blue-400")
      }
      disabled={loading}
    >
